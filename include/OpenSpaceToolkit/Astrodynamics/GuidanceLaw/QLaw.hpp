...
class QLaw : public GuidanceLaw
{
   public:
    ...
    /// @brief Compute the derivative of the orbital elements with respect to the thrust direction
    ///
    ...
    ///
    /// @return The derivative of the orbital elements with respect to the thrust direction
