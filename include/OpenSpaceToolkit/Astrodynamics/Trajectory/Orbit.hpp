...
class Orbit : public Trajectory
{
   public:
    ...
    Orbit(const Array<State>& aStateArray, const Integer& anInitialRevolutionNumber,
    ...
    static Orbit Circular(const Instant& anEpoch, const Length& anAltitude, const Angle& anInclination,
                          const Shared<const Celestial>& aCelestialObjectSPtr);
    ...
    static Orbit Equatorial(const Instant& anEpoch, const Length& anApoapsisAltitude, const Length& aPeriapsisAltitude,
                            const Shared<const Celestial>& aCelestialObjectSPtr);
    ...
    static Orbit CircularEquatorial(const Instant& anEpoch, const Length& anAltitude,
                                    const Shared<const Celestial>& aCelestialObjectSPtr);
    ...
    static Orbit SunSynchronous(const Instant& anEpoch, const Length& anAltitude,
