...
class SatelliteSystem : public System
{
   public:
    ...
    SatelliteSystem(const Mass& aMass, const Composite& aSatelliteGeometry, const Matrix3d& anInertiaTensor,
                    const Real& aCrossSectionalSurfaceArea, const Real& aDragCoefficient);
