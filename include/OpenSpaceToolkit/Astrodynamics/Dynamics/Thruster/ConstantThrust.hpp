...
#ifndef __OpenSpaceToolkit_Astrodynamics_Dynamics_Thruster_ConstantThrust__
#define __OpenSpaceToolkit_Astrodynamics_Dynamics_Thruster_ConstantThrust__
...
class ConstantThrust : public Thruster
{
   public:
    ...
    static ConstantThrust Intrack(
        const SatelliteSystem& aSatelliteSystem,
        const bool& velocityDirection = true,
