...
Define an orbit model that is propagated using numerical propagation.  
...
\begin{DoxyCompactList}\small\item\em Calculate the state at an instant, utilizing internal cached state array to propagated shortest amount of time. Does not have macro-\/level sorting optimization, should not be used with disorded instant array. \end{DoxyCompactList}\item 
...
{\em a\+Propagator} & A propagator \\
\hline
{\em a\+Cached\+State\+Array} & A state array \\
\hline
\end{DoxyParams}
...
Calculate the state at an instant, utilizing internal cached state array to propagated shortest amount of time. Does not have macro-\/level sorting optimization, should not be used with disorded instant array. 


\begin{DoxyCode}{0}
\DoxyCodeLine{Array<State> states = propagated.calculateStatesAt(anInstantArray) ;}
\end{DoxyCode}
 
\begin{DoxyParams}{Parameters}
{\em a\+State} & An initial state \\
\hline
{\em an\+Instant\+Array} & An instant \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Array$<$\+State$>$ 
...
\begin{DoxyParams}{Parameters}
{\em a\+Propagated\+Model} & A propagated \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\begin{DoxyParams}{Parameters}
{\em a\+State\+Array} & A state array \\
\hline
\end{DoxyParams}
