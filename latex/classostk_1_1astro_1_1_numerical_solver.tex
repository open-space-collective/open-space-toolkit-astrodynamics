...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classostk_1_1astro_1_1_numerical_solver_ac67671257ab8be4f684842505f4ce8d8}{NumericalSolver}} numericalSolver = \{ aLogType, aStepperType, aTimeStep, aRelativeTolerance,}
\DoxyCodeLine{anAbsoluteTolerance \} ;}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{classostk_1_1astro_1_1_numerical_solver_a4a1673a6f74a72d6bacfe6480b9c1ccd}{StateVector}} stateVector = numericalsolver.integrateStateFromInstantToInstant(stateVector,}
\DoxyCodeLine{instant, otherInstant, SystemofEquations) ;}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Array<StateVector> stateVectorArray =}
\DoxyCodeLine{numericalSolver.integrateStatesAtSortedInstants(stateVector, instant, instantArray,}
