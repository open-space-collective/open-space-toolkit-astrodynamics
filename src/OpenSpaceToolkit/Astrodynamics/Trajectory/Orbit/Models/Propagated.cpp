...
State                           Propagated::calculateStateAt                    (   const   Instant&                anInstant                                   ) const
{
    ...
    SatelliteDynamics::StateVector startStateVector((size_t)satelliteDynamics_.getStateVectorType()) ;
    ...
    SatelliteDynamics::StateVector propagatedStateVector = numericalSolver_.integrateStateForDuration(startStateVector, propDuration, satelliteDynamics_.accessDynamicalEquations()) ;
