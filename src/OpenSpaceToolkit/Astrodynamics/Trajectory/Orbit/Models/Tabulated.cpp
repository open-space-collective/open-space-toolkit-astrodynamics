...
/// @file           OpenSpaceToolkit/Astrodynamics/Trajectory/Orbit/Models/Tabulated.cpp
...
Tabulated::Tabulated(const Array<State>& aStateArray, const Integer& anInitialRevolutionNumber)
