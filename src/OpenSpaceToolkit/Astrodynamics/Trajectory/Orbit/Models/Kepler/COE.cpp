...
/// @file           OpenSpaceToolkit/Astrodynamics/Trajectory/Orbit/Models/Kepler/COE.cpp
...
COE::COE(const Length& aSemiMajorAxis, const Real& anEccentricity, const Angle& anInclination, const Angle& aRaan,
         const Angle& anAop, const Angle& aTrueAnomaly)
...
Angle COE::EccentricAnomalyFromMeanAnomaly(const Angle& aMeanAnomaly, const Real& anEccentricity,
