...
/// @file           OpenSpaceToolkit/Astrodynamics/Trajectory/Orbit/Models/Propagator.cpp
...
Integer                         Propagator::calculateRevolutionNumberAt     (   const   Instant&                    anInstant                                   ) const
{
    ...
    throw ostk::core::error::runtime::ToBeImplemented("Propagator :: calculateRevolutionNumberAt") ; // [TBI]
