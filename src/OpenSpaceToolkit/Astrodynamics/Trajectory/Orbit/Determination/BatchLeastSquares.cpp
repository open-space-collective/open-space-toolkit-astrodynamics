...
/// @file           OpenSpaceToolkit/Astrodynamics/Trajectory/Orbit/Determination/BatchLeastSquares.cpp
...
BatchLeastSquares::Output       BatchLeastSquares::estimateOrbit            (   const   Array<Pair<Instant, Position>>& aMeasurementArray                       ) const
{
    ...
    {
        throw ostk::core::error::RuntimeError("At least 2 measurements must be provided.") ;
    }
    ...
    [] (const std::vector<double>& aStateVector, std::vector<double>& aGradientVector, void* aContextPtr) -> double
    {
        ...
        {
            throw ostk::core::error::runtime::Undefined("Context") ;
        }
    ...
    {
        throw ostk::core::error::RuntimeError("Algorithm [{}] is wrong.", configuration_.algorithm) ;
    }
    ...
    try
    {
        ...
        switch (result)
        {
            ...
            default:
                ...
                // throw ostk::core::error::RuntimeError("Cannot estimate orbit (solution did not converge).") ;
                break ;
    ...
    {
        // throw ostk::core::error::RuntimeError("Cannot estimate orbit (algorithm failed): [{}].", anException.what()) ;
