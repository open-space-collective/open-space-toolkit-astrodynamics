...
SatelliteSystem::SatelliteSystem(const Mass& aMass, const Composite& aSatelliteGeometry,
                                 const Matrix3d& anInertiaTensor, const Real& aCrossSectionalSurfaceArea,
