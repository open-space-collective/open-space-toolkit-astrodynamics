...
/// @file           OpenSpaceToolkit/Astrodynamics/Flight/Profile/Models/Tabulated.cpp
...
State                           Tabulated::calculateStateAt                 (   const   Instant&                    anInstant                                   ) const
{
    ...
    if ((stateRange.first != nullptr) && (stateRange.second != nullptr))
    {
        ...
        return
        {
            ...
            Position
            {
                previousState.accessPosition().accessCoordinates() + ratio * (nextState.accessPosition().accessCoordinates() - previousState.accessPosition().accessCoordinates()),
                previousState.accessPosition().getUnit(),
                previousState.accessPosition().accessFrame()
            },
            Velocity
            {
                previousState.accessVelocity().accessCoordinates() + ratio * (nextState.accessVelocity().accessCoordinates() - previousState.accessVelocity().accessCoordinates()),
            ...
            previousState.accessAngularVelocity() + ratio * (nextState.accessAngularVelocity() - previousState.accessAngularVelocity()),
