...
/// @file           OpenSpaceToolkit/Astrodynamics/Flight/Profile/Models/Transform.cpp
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                ...
                                Transform::Transform                        (   const   DynamicProvider&            aDynamicTransformProvider,
...
Shared<const Frame>             Transform::getBodyFrame                     (   const   String&                     aFrameName                                  ) const
{
    ...
    return Frame::Construct(aFrameName, false, this->frameSPtr_, std::make_shared<const DynamicProvider>(dynamicTransformProvider)) ;

}

void                            Transform::print                            (           std::ostream&               anOutputStream,
...
Transform                       Transform::InertialPointing                 (   const   Trajectory&                 aTrajectory,
