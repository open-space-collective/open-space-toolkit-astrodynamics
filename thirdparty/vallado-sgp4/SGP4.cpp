...
// use extern in main
// PATCH (Open Space Toolkit): internal linkage. Both are only touched by the "debug*.cpp"
// includes, which are commented out upstream; at external linkage the shared library would
// export a symbol named `help`.
static char help __attribute__((unused)) = 'n';
static FILE *dbgfile __attribute__((unused));
...
namespace SGP4Funcs
{
	...
	*    the parabolic limit at 168deg is arbitrary. the hyperbolic anomaly is also
