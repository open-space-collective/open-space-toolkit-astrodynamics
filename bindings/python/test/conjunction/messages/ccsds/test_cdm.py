...
class TestCDM:
    ...
    def test_get_header (self, cdm: CDM):
        ...
        assert cdm_header.creation_date == Instant.date_time(datetime(2010, 3, 12, 22, 31, 12), Scale.UTC)
    ...
    def test_get_relative_metadata (self, cdm: CDM):
        ...
        assert cdm_relative_metadata.time_of_closest_approach == Instant.date_time(datetime(2010, 3, 13, 22, 37, 52, 618), Scale.UTC)
        assert cdm_relative_metadata.miss_distance == Length.meters(715.0)
        assert cdm_relative_metadata.start_screen_period == Instant.date_time(datetime(2010, 3, 12, 18, 29, 32, 212), Scale.UTC)
        assert cdm_relative_metadata.end_screen_period == Instant.date_time(datetime(2010, 3, 15, 18, 29, 32, 212), Scale.UTC)
        ...
        assert cdm_relative_metadata.screen_entry_time == Instant.date_time(datetime(2010, 3, 13, 22, 37, 52, 222), Scale.UTC)
        assert cdm_relative_metadata.screen_exit_time == Instant.date_time(datetime(2010, 3, 13, 22, 37, 52, 824), Scale.UTC)
    ...
    def test_get_object_data_at (self, cdm: CDM):
        ...
        assert cdm_object_1_data.time_last_observation_start == Instant.date_time(datetime(2010, 3, 12, 2, 14, 12, 746), Scale.UTC)
        assert cdm_object_1_data.time_last_observation_end == Instant.date_time(datetime(2010, 3, 12, 2, 14, 12, 746), Scale.UTC)
        ...
        assert cdm_object_2_data.time_last_observation_start == Instant.date_time(datetime(2010, 3, 12, 2, 14, 12, 746), Scale.UTC)
        assert cdm_object_2_data.time_last_observation_end == Instant.date_time(datetime(2010, 3, 12, 2, 14, 12, 746), Scale.UTC)
    ...
    def test_get_creation_instant (self, cdm: CDM):
        ...
        assert cdm.get_creation_instant() == Instant.date_time(datetime(2010, 3, 12, 22, 31, 12), Scale.UTC)
    ...
    def test_get_time_of_closest_approach (self, cdm: CDM):
        ...
        assert cdm.get_time_of_closest_approach() == Instant.date_time(datetime(2010, 3, 13, 22, 37, 52, 618), Scale.UTC)
    ...
    def test_dictionary (self, cdm_spacetrack_dictionary: dict):
        ...
        assert cdm.get_ccsds_cdm_version() == '1.0'
        assert cdm.get_creation_instant() == Instant.date_time(datetime(2022, 12, 25, 0, 33, 16), Scale.UTC)
        assert cdm.get_originator() == 'CSpOC'
        assert cdm.get_message_for() == 'YAM-2'
        assert cdm.get_message_id() == '406320986'
        assert cdm.get_time_of_closest_approach() == Instant.date_time(datetime(2022, 12, 27, 13, 28, 59, 516000), Scale.UTC)
