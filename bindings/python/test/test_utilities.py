...
class TestUtilities:
    ...
    def test_lla_from_position (self,
                                instant: Instant,
                                position: Position,
                                state: State):
    ...
    def test_compute_time_lla_aer_state (self,
                                         state: State,
                                         position: Position,
                                         environment: Environment):

        time_lla_aer: list = utilities.compute_time_lla_aer_state(state, position, environment)
    ...
    def test_compute_trajectory_geometry (self,
                                          interval: Interval,
