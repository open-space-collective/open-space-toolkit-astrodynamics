...
inline void                     OpenSpaceToolkitAstrodynamicsPy_Trajectory_Orbit_Models_Kepler_COE (        pybind11::module& aModule                           )
{
    ...
    class_<COE>(aModule, "COE")
        ...
        .def_static("eccentric_anomaly_from_true_anomaly", &COE::EccentricAnomalyFromTrueAnomaly, arg("true_anomaly"), arg("eccentricity"))
        .def_static("true_anomaly_from_eccentric_anomaly", &COE::TrueAnomalyFromEccentricAnomaly, arg("eccentric_anomaly"), arg("eccentricity"))
        .def_static("mean_anomaly_from_eccentric_anomaly", &COE::MeanAnomalyFromEccentricAnomaly, arg("eccentric_anomaly"), arg("eccentricity"))
        .def_static("eccentric_anomaly_from_mean_anomaly", &COE::EccentricAnomalyFromMeanAnomaly, arg("mean_anomaly"), arg("eccentricity"), arg("tolerance"))
