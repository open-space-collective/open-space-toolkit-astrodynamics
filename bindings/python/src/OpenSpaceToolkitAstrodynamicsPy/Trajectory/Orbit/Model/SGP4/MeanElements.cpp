...
inline void OpenSpaceToolkitAstrodynamicsPy_Trajectory_Orbit_Model_SGP4_MeanElements(pybind11::module& aModule)
{
    ...
    class_<MeanElements>(
        ...
        R"doc(
            ...
            A TLE is a lossy serialization of this: writing one rounds the eccentricity to 1e-7
            and the angles to 1e-4 degrees. That rounding is harmless for propagation but fatal
            ...
            Jacobian silently loses rank. Estimators should iterate on `MeanElements` and serialize
            a TLE once, at the end.
