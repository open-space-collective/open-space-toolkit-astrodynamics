...
inline void OpenSpaceToolkitAstrodynamicsPy_EventCondition_AngularCondition(nanobind::module_& aModule)
{
    {
        class_<AngularCondition, EventCondition> angularCondition(
            aModule,
            "AngularCondition",
            R"doc(
