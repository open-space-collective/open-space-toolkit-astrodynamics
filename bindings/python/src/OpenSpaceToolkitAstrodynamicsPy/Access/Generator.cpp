...
inline void OpenSpaceToolkitAstrodynamicsPy_Access_Generator(pybind11::module& aModule)
{
    ...
    class_<Generator, Shared<Generator>>(aModule, "Generator")
        ...
        .def(init<const Environment&, std::function<bool(const AER&)>&, std::function<bool(const Access&)>&,
                  std::function<bool(const State&, const State&)>&, const Duration&, const Duration&>(),
             arg("environment"), arg("aer_filter") = none(), arg("access_filter") = none(),
             arg("state_filter") = none(), arg("step") = DEFAULT_STEP, arg("tolerance") = DEFAULT_TOLERANCE)
        ...
        .def("compute_accesses", &Generator::computeAccesses, arg("interval"), arg("from_trajectory"),
             arg("to_trajectory"))
        ...
        .def_static("aer_ranges", &Generator::AerRanges, arg("azimuth_range"), arg("elevation_range"),
                    arg("range_range"), arg("environment"))
        .def_static("aer_mask", &Generator::AerMask, arg("azimuth_elevation_mask"), arg("range_range"),
                    arg("environment"))
