...
BEGIN Scenario
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            Name		 t_UTC x_GCRF v_GCRF q_B_GCRF w_B_GCRF_in_GCRF
            Type		 Report
            BaseDir		 User
            Style		 t_UTC x_GCRF v_GCRF q_B_GCRF w_B_GCRF_in_GCRF
            AGIViewer		 Yes
...
"1 Jan 2018 00:00:00.000000000" "2 Jan 2018 00:00:00.000000000"
            ...
            WindowRectLeft		 382
            WindowRectTop		 287
            WindowRectRight		 2373
            WindowRectBottom		 981
        END Report

        BEGIN Report
            Name		 t_UTC x_GCRF v_GCRF q_B_GCRF w_B_GCRF_in_GCRF1
            Type		 Report
            BaseDir		 User
            Style		 t_UTC x_GCRF v_GCRF q_B_GCRF w_B_GCRF_in_GCRF
            AGIViewer		 Yes
...
"1 Jan 2018 00:00:00.000000000" "2 Jan 2018 00:00:00.000000000"
            ...
            WindowRectLeft		 538
            WindowRectTop		 443
            WindowRectRight		 2529
            WindowRectBottom		 1137
        END Report

        BEGIN Report
            Name		 t_UTC x_GCRF v_GCRF q_B_GCRF w_B_GCRF_in_GCRF2
            Type		 Report
            BaseDir		 User
            Style		 t_UTC x_GCRF v_GCRF q_B_GCRF w_B_GCRF_in_GCRF
            AGIViewer		 Yes
...
"1 Jan 2018 00:00:00.000000000" "2 Jan 2018 00:00:00.000000000"
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 2.21868e+07
            LaunchWindowStop		 2.21868e+07
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 14 Sep 2018 19:00:00.000000000
                    Stop		 15 Sep 2018 19:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        ...
                        SecondaryBody		 Sun
                        CenterLatitude		 0
                        CenterLongitude		 19.04516129032257
