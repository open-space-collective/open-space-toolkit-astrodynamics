...
TEST (Library_Astrodynamics_Trajectory_Orbit_Models_Kepler, Test_1)
{
...

    {
        ...
        const Table referenceData = Table::Load(File::Path(Path::Parse("../test/Library/Astrodynamics/Trajectory/Orbit/Models/Kepler/Test1/Satellite1 Orbit.csv")), Table::Format::CSV, true) ;
