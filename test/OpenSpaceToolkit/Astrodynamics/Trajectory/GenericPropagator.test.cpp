...
using ostk::astro::flight::system::dynamics::AugmentedSatelliteDynamics;
using ostk::astro::trajectory::State;
using ostk::astro::trajectory::AbstractState;

using ostk::astro::trajectory::GenericPropagator;

/* UNIT TESTS */
class OpenSpaceToolkit_Astrodynamics_Trajectory_Orbit_Models_GenericPropagator : public ::testing::Test
{
   protected:
    void SetUp() override
    {
...
TEST_F(OpenSpaceToolkit_Astrodynamics_Trajectory_Orbit_Models_GenericPropagator, CalculateStatesAt_SatelliteDynamics)
{
    const Composite satelliteGeometry(Cuboid(
        {0.0, 0.0, 0.0}, {Vector3d {1.0, 0.0, 0.0}, Vector3d {0.0, 1.0, 0.0}, Vector3d {0.0, 0.0, 1.0}}, {1.0, 2.0, 3.0}
    ));
    ...
    const GenericPropagator propagator = {satelliteDynamics, numericalSolver_};
    ...
    // Test forward propagation
    {
        ...
        const AbstractState state = AbstractState(
            initialInstant,
            {7000000.0, 0.0, 0.0, 0.0, 5335.865450622126, 5335.865450622126}
        );

        const Array<AbstractState> propagatedStateArray = propagator.calculateStatesAt(state, instantArray);

    }
}

TEST_F(OpenSpaceToolkit_Astrodynamics_Trajectory_Orbit_Models_GenericPropagator, CalculateStatesAt_AugmentedSatelliteDynamics)
{
    const Composite satelliteGeometry(Cuboid(
        {0.0, 0.0, 0.0}, {Vector3d {1.0, 0.0, 0.0}, Vector3d {0.0, 1.0, 0.0}, Vector3d {0.0, 0.0, 1.0}}, {1.0, 2.0, 3.0}
    ));
    ...
    // Satellite dynamics setup
    AugmentedSatelliteDynamics satelliteDynamics = {customEnvironment, satelliteSystem};
