...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, Constructor)
{
    {
...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, EqualToOperator)
{
    {
        EXPECT_TRUE(
...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, NotEqualToOperator)
{
    {
        EXPECT_FALSE(
            CartesianVelocity("NAME", CartesianPosition::ThreeDimensional()) !=
...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, Getters)
{
...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, Add)
{
    {
...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, Subtract)
{
    {
        const Shared<const CartesianVelocity> cartesianVelocity =
            CartesianVelocity::FromPosition(CartesianPosition::ThreeDimensional());
...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, InFrame)
{
    {
...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, FromPosition)
{
    {
...
TEST(OpenSpaceToolkit_Astrodynamics_Trajectory_State_CoordinatesSubsets_CartesianVelocity, ThreeDimensional)
{
    {
