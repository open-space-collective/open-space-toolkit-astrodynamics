...
BEGIN Scenario
    ...
    BEGIN Epoch
        ...
        Epoch		 1 Jan 2019 00:00:00.000000000
        SmartEpoch
        BEGIN EVENT
            Epoch		 1 Jan 2019 00:00:00.000000000
            EventEpoch
    ...
    BEGIN Interval
        ...
        Start		 1 Jan 2019 00:00:00.000000000
        Stop		 2 Jan 2019 00:00:00.000000000
        SmartInterval
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Jan 2019 00:00:00.000000000
    ...
    BEGIN QuickReports
        ...
        BEGIN Report
            Name		 t_UTC x_GCRF v_GCRF rev
            Type		 Report
            BaseDir		 User
            Style		 t_UTC x_GCRF v_GCRF rev
            AGIViewer		 Yes
            Instance		 Satellite/CircularEquatorialOrbit
            BEGIN TimeData
                BEGIN Section
                    SectionNumber		 1
                    SectionType		 2
...
"1 Jan 2019 00:00:00.000000000" "2 Jan 2019 00:00:00.000000000"
                        END Intervals
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 1.251e+07
            LaunchWindowStop		 1.251e+07
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 25 May 2019 19:00:00.000000000
                    Stop		 26 May 2019 19:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
...
<VAR name = "STK_RF_Environment">
    <SCOPE Class = "RFEnvironment">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Jan 2019 00:00:00.000000000
                EndTime		 2 Jan 2019 00:00:00.000000000
            ...
            BEGIN MapData
                ...
                BEGIN MapStyles
                    ...
                    BEGIN Style
                        ...
                        BEGIN SoftVTR
                            OutputFormat		 WMV
                            Directory		 Z:\Projects\Engineering\open-space-collective\open-space-toolkit-astrodynamics\test\OpenSpaceToolkit\Astrodynamics\Trajectory\Orbit\Models\Propagator\Test_1\CircularOrbit
                            BaseName		 Frame
                            Digits		 4
                            Frame		 0
                            LastAnimTime		 0
    ...
    BEGIN SubObjects
        ...
        Class Satellite
            ...
            CircularEquatorialOrbit
            CircularInclinedOrbit
            CircularPolarOrbit
            EllipticalEquatorialOrbit
            EllipticalInclinedOrbit
            EllipticalPolarOrbit
    ...
    BEGIN References
        ...
        END Instance
        Instance Satellite/CircularEquatorialOrbit
            Satellite/CircularEquatorialOrbit
        END Instance
        Instance Satellite/CircularInclinedOrbit
            Satellite/CircularInclinedOrbit
        END Instance
        Instance Satellite/CircularPolarOrbit
            Satellite/CircularPolarOrbit
        END Instance
        Instance Satellite/EllipticalEquatorialOrbit
            Satellite/EllipticalEquatorialOrbit
        END Instance
        Instance Satellite/EllipticalInclinedOrbit
            Satellite/EllipticalInclinedOrbit
        END Instance
        Instance Satellite/EllipticalPolarOrbit
            Satellite/EllipticalPolarOrbit
        END Instance
    END References
