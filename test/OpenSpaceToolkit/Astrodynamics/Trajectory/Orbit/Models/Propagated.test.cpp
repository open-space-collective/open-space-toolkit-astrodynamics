...
//     const State state_1 = {
//         instant_1, Position::Meters({0.0, 0.0, 0.0}, gcrfSPtr_), Velocity::MetersPerSecond({1.0, 0.0, 0.0},
//         gcrfSPtr_)};
...
//     Array<Instant> instantArray = Array<Instant>::Empty();
//     for (size_t i = 0; i < (propagationSpanHours * 3600) / propagationIntervalSeconds; i +=
...
//         // const double timeAverage_default = std::accumulate(timeArray_default.begin(), timeArray_default.end(),
//         0.0) /
