...
/// @file           OpenSpaceToolkit/Astrodynamics/Conjunction/Messages/CCSDS/CDM.test.cpp
...
class OpenSpaceToolkit_Astrodynamics_Conjunction_Messages_CCSDS_OPM : public ::testing::Test {

    protected:

        // https://public.ccsds.org/Pubs/508x0b1e2c2.pdf (section 3.6.2 - page 3-11)
...
TEST_F (OpenSpaceToolkit_Astrodynamics_Trajectory_Orbit_Messages_SpaceX_OPM, Load)
{
...

    {
        ...
        const OPM opm = OPM::Load(File::Path(Path::Parse("/app/test/OpenSpaceToolkit/Astrodynamics/Trajectory/Orbit/Messages/SpaceX/OPM/opm_1.yaml"))) ;
        ...
        EXPECT_EQ(Position::Meters({ 693289.644, 6876578.628, -133035.288 }, Frame::ITRF()), opm.getDeployments()[0].position) ;
        EXPECT_EQ(Velocity::MetersPerSecond({ 1305.783, 39.783, 7525.920 }, Frame::ITRF()), opm.getDeployments()[0].velocity) ;
        ...
        EXPECT_EQ(Position::Meters({ 699863.059, 6875647.517, -123777.595 }, Frame::ITRF()), opm.getDeployments()[1].position) ;
        EXPECT_EQ(Velocity::MetersPerSecond({ 1504.658, 6.705, 7538.669 }, Frame::ITRF()), opm.getDeployments()[1].velocity) ;
