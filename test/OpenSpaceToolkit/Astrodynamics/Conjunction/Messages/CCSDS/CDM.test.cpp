...
TEST_F (OpenSpaceToolkit_Astrodynamics_Conjunction_Messages_CCSDS_CDM, GetRelativeMetadata)
{

    {
        ...
        EXPECT_EQ(Instant::DateTime(DateTime(2010, 3, 12, 18, 29, 32, 212), Scale::UTC), relativeMetadata.startScreenPeriod) ;
        EXPECT_EQ(Instant::DateTime(DateTime(2010, 3, 15, 18, 29, 32, 212), Scale::UTC), relativeMetadata.endScreenPeriod) ;
        ...
        EXPECT_EQ(Instant::DateTime(DateTime(2010, 3, 13, 22, 37, 52, 222), Scale::UTC), relativeMetadata.screenEntryTime) ;
        EXPECT_EQ(Instant::DateTime(DateTime(2010, 3, 13, 22, 37, 52, 824), Scale::UTC), relativeMetadata.screenExitTime) ;
...
TEST_F (OpenSpaceToolkit_Astrodynamics_Conjunction_Messages_CCSDS_CDM, Load)
{
...

    {
        ...
        const CDM cdm = CDM::Load(File::Path(Path::Parse("/app/test/OpenSpaceToolkit/Astrodynamics/Conjunction/Messages/CCSDS/CDM/cdm.json"))) ;
