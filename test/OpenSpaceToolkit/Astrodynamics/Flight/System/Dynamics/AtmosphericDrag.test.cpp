...
TEST_F(OpenSpaceToolkit_Astrodynamics_Flight_System_Dynamics_AtmosphericDrag, GetReadCoordinatesSubsets)
{
    ...
    EXPECT_EQ(CartesianVelocity::ThreeDimensional(), subsets[1]);
}
...
TEST_F(OpenSpaceToolkit_Astrodynamics_Flight_System_Dynamics_AtmosphericDrag, ComputeContribution)
{
    ...
    x << startStateVector_[0], startStateVector_[1], startStateVector_[2], startStateVector_[3], startStateVector_[4],
        startStateVector_[5];

    const VectorXd contribution = atmosphericDrag.computeContribution(startInstant_, x, Frame::GCRF());
...
//             dynamics, startInstant_, Array<Array<Pair<Index, Size>>>::Empty(), Array<Array<Pair<Index,
//             Size>>>::Empty()
//         ),
//         startStateVector_,
//         (0.0),
