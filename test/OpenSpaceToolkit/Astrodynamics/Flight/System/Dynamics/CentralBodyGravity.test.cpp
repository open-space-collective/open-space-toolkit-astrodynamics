...
TEST_F(OpenSpaceToolkit_Astrodynamics_Flight_System_Dynamics_CentralBodyGravity, ComputeContribution)
{
    ...
    x << startStateVector_[0], startStateVector_[1], startStateVector_[2];

    const VectorXd contribution = centralBodyGravity.computeContribution(startInstant_, x, Frame::GCRF());
