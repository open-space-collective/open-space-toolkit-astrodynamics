...
TEST(OpenSpaceToolkit_Astrodynamics_Flight_System_SatelliteSystem, Constructor)
{
    ...
    // Normal constructor
    {
        ...
        const std::array<Vector3d, 3> axes = {Vector3d{1.0, 0.0, 0.0}, Vector3d{0.0, 1.0, 0.0},
        ...
        EXPECT_NO_THROW(SatelliteSystem satellitesystem(satelliteMass, satelliteGeometry, satelliteInertiaTensor,
                                                        crossSectionalSurfaceArea, dragCoefficient));
    }
}
...
TEST(OpenSpaceToolkit_Astrodynamics_Flight_System_SatelliteSystem, CopyConstructor)
{
    ...
    // Copy constructor
    {
        ...
        // Construct SatelliteSystem object
        const SatelliteSystem satellitesystem = {satelliteMass, satelliteGeometry, satelliteInertiaTensor,
                                                 crossSectionalSurfaceArea, dragCoefficient};
...
TEST(OpenSpaceToolkit_Astrodynamics_Flight_System_SatelliteSystem, EqualToOperator)
{
...

    {
        ...
        const SatelliteSystem satelliteSystem_1 = {satelliteMass_1, satelliteGeometry, satelliteInertiaTensor, 0.8,
                                                   2.2};
        ...
        const SatelliteSystem satelliteSystem_3 = {satelliteMass, satelliteGeometry_0, satelliteInertiaTensor, 0.8,
                                                   2.2};
        ...
        const SatelliteSystem satelliteSystem_2 = {satelliteMass, satelliteGeometry, satelliteInertiaTensor_0, 0.8,
                                                   2.2};
...
TEST(OpenSpaceToolkit_Astrodynamics_Flight_System_SatelliteSystem, getCrossSectionalSurfaceArea)
{
...

    {
        ...
        // Construct SatelliteSystem object
        const SatelliteSystem satelliteSystem = {satelliteMass, satelliteGeometry, satelliteInertiaTensor, surfaceArea,
                                                 2.2};
...
TEST(OpenSpaceToolkit_Astrodynamics_Flight_System_SatelliteSystem, getDragCoefficient)
{
...

    {
        ...
        // Construct SatelliteSystem object
        const SatelliteSystem satelliteSystem = {satelliteMass, satelliteGeometry, satelliteInertiaTensor, 0.8,
                                                 dragCoefficient};
