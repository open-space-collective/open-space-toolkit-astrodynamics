...
// TEST_F(OpenSpaceToolkit_Astrodynamics_EventCondition_Disjunctive, isSatisfiedFromCache)
// {
//     // x0 crossing root (true), x1 negative (true)
//     {
//         VectorXd currentState(2);
...
//         disjunctionCondition_.setValue(previousState, 0.0);
//         EXPECT_TRUE(disjunctionCondition_.isSatisfiedFromCache(currentState, 1.0));
//     }
...
//         disjunctionCondition_.setValue(previousState, 0.0);
//         EXPECT_FALSE(disjunctionCondition_.isSatisfiedFromCache(currentState, 1.0));
//     }
