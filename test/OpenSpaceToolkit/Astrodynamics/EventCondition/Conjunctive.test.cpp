...
// TEST_F(OpenSpaceToolkit_Astrodynamics_EventCondition_Conjunctive, isSatisfiedFromCache)
// {
//     // x0 crossing root (true), x1 negative (true)
//     {
//         VectorXd currentState(2);
...
//         conjuntionCondition_.setValue(previousState, 0.0);
//         EXPECT_TRUE(conjuntionCondition_.isSatisfiedFromCache(currentState, 1.0));
//     }
...
//         conjuntionCondition_.setValue(previousState, 0.0);
//         EXPECT_FALSE(conjuntionCondition_.isSatisfiedFromCache(currentState, 1.0));
//     }
