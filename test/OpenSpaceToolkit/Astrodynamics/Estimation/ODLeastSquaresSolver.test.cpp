...
using ostk::astrodynamics::estimation::ODLeastSquaresSolver;
   ...
   protected:
    void SetUp() override
    {
        const Table referenceData = Table::Load(
            File::Path(Path::Parse("/app/test/OpenSpaceToolkit/Astrodynamics/Estimation/gnss_data.csv")),
            Table::Format::CSV,
            true
        );
    ...
    std::unordered_map<CoordinateSubset, Real> referenceStateSigmas_ = {
        {*CartesianPosition::Default(), 1.0e1},
        {*CartesianVelocity::Default(), 1.0e-2},
    };
    std::unordered_map<CoordinateSubset, Real> initialStateSigmas_ = {
        {*CartesianPosition::Default(), 1.0e2},
        {*CartesianVelocity::Default(), 1.0e-1},
    };
};
...
TEST_F(OpenSpaceToolkit_Astrodynamics_Solver_ODLeastSquaresSolver, EstimateState)
{
    ...
    {
        // Test with estimation coordinate subsets
...
{
    {
        // Test invalid estimation subsets
...
TEST_F(OpenSpaceToolkit_Astrodynamics_Solver_ODLeastSquaresSolver, EstimateOrbit)
{
    ...
    {
        // Test orbit estimation with estimation subsets and sigmas
